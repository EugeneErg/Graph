...
/**
 * @var VertexesCollection $vertexes
 * @var ConnectionsCollection $connections
 * @var int $vertexRadius
 * @var Point2D $minPoint
 * @var Point2D $maxPoint
 */
?>
<svg version="1.1"
     width="<?= $maxPoint->getX() - $minPoint->getX() + $vertexRadius * 2 ?>"
     height="<?= $maxPoint->getY() - $minPoint->getY() + $vertexRadius * 2 ?>"
     stroke="black"
     stroke-width="1"
     vector-effect="non-scaling-stroke"
     fill="white"
     viewBox="
        <?= $minPoint->getX() - $vertexRadius ?>
        <?= $minPoint->getY() - $vertexRadius ?>
        <?= $maxPoint->getX() - $minPoint->getX() + $vertexRadius * 2 ?>
        <?= $maxPoint->getY() - $minPoint->getY() + $vertexRadius * 2 ?>"
